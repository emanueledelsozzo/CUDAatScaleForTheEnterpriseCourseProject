# edgeDetector - Edge Detector with NPP

## Description

A CUDA-based application that uses the NPP FilterCannyBorder function to perform edge detection on grayscale images (pgm format).
